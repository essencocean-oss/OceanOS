...
export const tauri = {
  ...
  onChatDone: (..._args: any[]) => () => {},
  onChatError: (..._args: any[]) => () => {},
  onChatReasoningChunk: (..._args: any[]) => () => {},
  onChatToolCall: (..._args: any[]) => () => {},
  onChatToolProgress: (..._args: any[]) => () => {},
  onChatToolEvent: (..._args: any[]) => () => {},
  onChatUsage: (..._args: any[]) => () => {},
  onContextMenuCopyChat: (..._args: any[]) => () => {},
  onContextMenuSelectBubble: (..._args: any[]) => () => {},
  onOAuthLoginProgress: (..._args: any[]) => () => {},
  onInstallProgress: (..._args: any[]) => () => {},
  onClarifyRequest: (..._args: any[]) => () => {},
  onMenuSearchSessions: (..._args: any[]) => () => {},
  onMenuNewChat: (..._args: any[]) => () => {},
  onUpdateAvailable: (..._args: any[]) => () => {},
  onUpdateDownloadProgress: (..._args: any[]) => () => {},
  onUpdateDownloaded: (..._args: any[]) => () => {},
  onUpdateError: (..._args: any[]) => () => {},
  // Memory
  addMemoryEntry: (..._args: any[]) => cmd("add_memory_entry"),
  updateMemoryEntry: (..._args: any[]) => cmd("update_memory_entry"),
  removeMemoryEntry: (..._args: any[]) => cmd("remove_memory_entry"),
  // Models / providers
  discoverProviderModels: (..._args: any[]) => cmd("discover_provider_models"),
  getModelContextWindow: (..._args: any[]) => cmd("get_model_context_window"),
  getCredentialPool: (..._args: any[]) => cmd("get_credential_pool"),
  addCredentialPoolEntry: (..._args: any[]) => cmd("add_credential_pool_entry"),
  setCredentialPool: (..._args: any[]) => cmd("set_credential_pool"),
  setCredentialPoolEntry: (..._args: any[]) => cmd("set_credential_pool_entry"),
  respondClarify: (..._args: any[]) => cmd("respond_clarify"),
  // Updates
  installUpdate: (..._args: any[]) => cmd("install_update"),
  downloadUpdate: (..._args: any[]) => cmd("download_update"),
  // i18n
