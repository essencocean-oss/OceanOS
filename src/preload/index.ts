...
const hermesAPI = {
  ...
  processesStart: (
    input: { label: string; command: string; args: string[]; cwd: string },
  ): Promise<{
    id: string;
    label: string;
    command: string;
    ...
    exitCode: number | null;
    error: string | null;
  }> => ipcRenderer.invoke("processes-start", input),

  processesKill: (id: string): Promise<boolean> =>
    ipcRenderer.invoke("processes-kill", id),

  processesRestart: (id: string): Promise<{
    id: string;
    label: string;
    command: string;
    args: string[];
    ...
    exitCode: number | null;
    error: string | null;
  } | null> => ipcRenderer.invoke("processes-restart", id),
};
