...
const PROFILES_DIR = join(OCEAN_HOME, "profiles");
...
export async function listProfiles(): Promise<ProfileInfo[]> {
  ...
  // Default profile is OCEAN_HOME itself
  const [
    defaultConfig,
    defaultHasEnv,
    defaultHasSoul,
    ...
    readProfileConfig(OCEAN_HOME),
    fileExists(join(OCEAN_HOME, ".env")),
    fileExists(join(OCEAN_HOME, "SOUL.md")),
    countSkills(OCEAN_HOME),
    isGatewayRunning(OCEAN_HOME),
  ]);
