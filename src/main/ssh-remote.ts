...
const DEFAULT_SOUL = `You are Ocean, a helpful AI assistant. You are friendly, knowledgeable, and always eager to help.
...
// Run a Ocean Kanban CLI subcommand over SSH and return a structured result.
