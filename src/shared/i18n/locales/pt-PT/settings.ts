export default {
  ...
  analytics: {
    ...
    hint: "Ajuda a melhorar o OceanOS ao enviar dados de utilização anónimos e agregados para a instância PostHog do projecto (alojada na UE). Pode desactivar a qualquer momento.",
    disclosure: {
  ...
  updateSuccess: "OceanOS actualizado com sucesso.",
  ...
  poolHint:
    "Adicione várias chaves de API para o mesmo fornecedor para rotação automática e balanceamento de carga. O OceanOS alternará entre elas.",
  add: "Adicionar",
  remove: "Remover",
  keyLabel: "Chave",
  empty: "(vazio)",
  dataSection: "Dados",
  dataHint:
    "Exporte ou importe a sua configuração do OceanOS, sessões, competências e memória.",
  ...
  migrationDesc:
    "Encontrámos o OpenClaw em <code>{{path}}</code>. Pode migrar a sua configuração, chaves de API, sessões e competências para o OceanOS.",
  ...
  modeLocal: "Local",
  modeRemote: "Remoto",
  modeLocalHint: "A usar o OceanOS instalado neste dispositivo",
  modeRemoteHint: "Ligar a um servidor da API do OceanOS na sua rede ou nuvem",
  remoteUrl: "URL Remoto",
  remoteUrlHint:
    "O URL do servidor da API do OceanOS (deve expor /health e /v1/chat/completions)",
