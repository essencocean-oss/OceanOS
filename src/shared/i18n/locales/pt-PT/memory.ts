export default {
  title: "Memória",
  subtitle: "O que o OceanOS se lembra sobre si e o seu ambiente entre sessões.",
  sessions: "Sessões",
  messages: "Mensagens",
  memories: "Memórias",
  ...
  noMemoriesYet:
    "Ainda sem memórias. O OceanOS guardará factos importantes à medida que conversam.",
  ...
  userProfileHint:
    "Fale ao OceanOS sobre si — nome, cargo, preferências, estilo de comunicação.",
  providersHint:
    "Fornecedores de memória modular dão ao OceanOS uma memória de longo prazo avançada. A memória integrada (acima) está sempre activa em conjunto com o fornecedor seleccionado.",
