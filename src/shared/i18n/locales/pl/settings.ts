export default {
  ...
  analytics: {
    ...
    hint: "Pomaga ulepszać OceanOS One przez wysyłanie anonimowych, zagregowanych danych użycia do instancji PostHog projektu. Możesz to wyłączyć w dowolnym momencie.",
    disclosure: {
  ...
  updateSuccess: "OceanOS został pomyślnie zaktualizowany.",
  ...
  poolHint:
    "Dodaj wiele kluczy API dla tego samego dostawcy, aby automatycznie rotować i równoważyć obciążenie. OceanOS będzie ich używał cyklicznie.",
  add: "Dodaj",
  remove: "Usuń",
  keyLabel: "Klucz",
  empty: "(puste)",
  dataSection: "Dane",
  dataHint:
    "Eksportuj lub importuj konfigurację OceanOS, sesje, umiejętności i pamięć.",
  ...
  migrationDesc:
    "Znaleziono OpenClaw w <code>{{path}}</code>. Możesz przenieść konfigurację, klucze API, sesje i umiejętności do OceanOS.",
  migrationDismiss: "Nie pokazuj ponownie",
  migrating: "Migrowanie...",
  migrateToOceanOS: "Migruj do OceanOS",
  skip: "Pomiń",
  ...
  modeLocal: "Lokalny",
  modeRemote: "Zdalny",
  modeLocalHint: "Używasz OceanOS zainstalowanego na tym urządzeniu",
  modeRemoteHint: "Połącz z serwerem API OceanOS w sieci lub chmurze",
  remoteUrl: "Zdalny URL",
  remoteUrlHint:
    "URL serwera API OceanOS (musi wystawiać /health i /v1/chat/completions)",
