export default {
  title: "Pamięć",
  subtitle: "Co OceanOS pamięta o Tobie i Twoim środowisku między sesjami.",
  sessions: "Sesje",
  messages: "Wiadomości",
  ...
  noMemoriesYet:
    "Brak pamięci. OceanOS będzie zapisywał ważne fakty podczas rozmowy.",
  ...
  userProfileHint:
    "Powiedz OceanOSowi o sobie — imię, rola, preferencje, styl komunikacji.",
  providersHint:
    "Wtykowe dostawcy pamięci dają OceanOSowi zaawansowaną pamięć długoterminową. Wbudowana pamięć (powyżej) zawsze działa razem z wybranym dostawcą.",
