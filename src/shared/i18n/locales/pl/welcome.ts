export default {
  ...
  dividerOr: "lub",
  connectRemote: "Połącz ze zdalnym OceanOS",
  connectRemoteTitle: "Połącz ze zdalnym OceanOS",
  connectRemoteSubtitle: "Podaj URL działającego serwera API OceanOS.",
