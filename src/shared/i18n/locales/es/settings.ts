export default {
  ...
  analytics: {
    ...
    hint: "Ayuda a mejorar OceanOS enviando datos de uso anónimos y agregados a la instancia PostHog del proyecto (alojada en la UE). Puedes desactivarlo en cualquier momento.",
    disclosure: {
  ...
  updateSuccess: "OceanOS se actualizó correctamente.",
  ...
  poolHint:
    "Agrega varias API keys para el mismo proveedor para la rotación automática y el equilibrio de carga. OceanOS alternará entre ellas.",
  add: "Agregar",
  remove: "Quitar",
  keyLabel: "Clave",
  empty: "(vacío)",
  dataSection: "Datos",
  dataHint:
    "Exporta o importa tu configuración de OceanOS, sesiones, habilidades y memoria.",
  ...
  migrationDesc:
    "Se encontró OpenClaw en <code>{{path}}</code>. Puedes migrar tu configuración, API keys, sesiones y habilidades a OceanOS.",
  migrationDismiss: "No volver a mostrar",
  migrating: "Migrando...",
  migrateToOceanOS: "Migrar a OceanOS",
  skip: "Omitir",
  ...
  modeLocal: "Local",
  modeRemote: "Remoto",
  modeLocalHint: "Usando OceanOS instalado en este dispositivo",
  modeRemoteHint:
    "Conectarse a un servidor de API de OceanOS en tu red o en la nube",
  remoteUrl: "URL remota",
  remoteUrlHint:
    "La URL del servidor de API de OceanOS (debe exponer /health y /v1/chat/completions)",
