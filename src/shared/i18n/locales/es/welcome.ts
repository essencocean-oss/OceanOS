export default {
  ...
  dividerOr: "o",
  connectRemote: "Conectarse a OceanOS remoto",
  connectRemoteTitle: "Conectarse a OceanOS remoto",
  connectRemoteSubtitle:
    "Introduce la URL de un servidor de API de OceanOS en ejecución.",
