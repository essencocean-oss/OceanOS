export default {
  ...
  dividerOr: "ou",
  connectRemote: "Conectar ao OceanOS Remoto",
  connectRemoteTitle: "Conectar ao OceanOS Remoto",
  connectRemoteSubtitle:
    "Insira a URL de um servidor da API do OceanOS em execução.",
