export default {
  ...
  analytics: {
    ...
    hint: "Ajuda a melhorar o OceanOS enviando dados de uso anônimos e agregados para a instância PostHog do projeto (hospedada na UE). Você pode desativar a qualquer momento.",
    disclosure: {
  ...
  updateSuccess: "OceanOS atualizado com sucesso.",
  ...
  poolHint:
    "Adicione várias chaves de API para o mesmo provedor para rotação automática e balanceamento de carga. O OceanOS alternará entre elas.",
  add: "Adicionar",
  remove: "Remover",
  keyLabel: "Chave",
  empty: "(vazio)",
  dataSection: "Dados",
  dataHint:
    "Exporte ou importe sua configuração do OceanOS, sessões, habilidades e memória.",
  ...
  migrationDesc:
    "Encontramos o OpenClaw em <code>{{path}}</code>. Você pode migrar sua configuração, chaves de API, sessões e habilidades para o OceanOS.",
  migrationDismiss: "Não mostrar novamente",
  migrating: "Migrando...",
  migrateToOceanOS: "Migrar para o OceanOS",
  skip: "Pular",
  ...
  modeLocal: "Local",
  modeRemote: "Remoto",
  modeLocalHint: "Usando o OceanOS instalado neste dispositivo",
  modeRemoteHint:
    "Conectar a um servidor da API do OceanOS na sua rede ou nuvem",
  remoteUrl: "URL Remota",
  remoteUrlHint:
    "A URL do servidor da API do OceanOS (deve expor /health e /v1/chat/completions)",
  ...
  serverConfigHint:
    "Você está conectado a um servidor remoto do OceanOS. A seleção de modelos, as chaves de API dos provedores e as credenciais são gerenciadas no host remoto em <code>~/.oceanos/.env</code> e <code>config.yaml</code>. Edite-os lá e reinicie o servidor.",
  connectionMode: "Modo",
