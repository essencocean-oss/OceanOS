export default {
  ...
  confirmUpdate:
    "Há uma instalação do OceanOS aqui — ela será atualizada para a versão mais recente.",
  confirmReplace:
    "Existe uma pasta aqui, mas não é uma instalação válida do OceanOS — instalar irá excluí-la e substituí-la.",
  confirmNotInherited:
    "Se você instalou o OceanOS em outro lugar, ou pela linha de comando, ela não será aproveitada.",
  ...
  useExistingDone:
    "Instalação existente definida — feche e reabra o OceanOS para aplicá-la.",
