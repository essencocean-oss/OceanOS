export default {
  ...
  installingOceanOS: "OceanOS Agent をインストール中",
  ...
  confirmLocationLabel: "OceanOS のインストール先:",
  confirmFresh:
    "ここに既存のインストールは見つかりませんでした。新しくインストールされます。",
  confirmUpdate:
    "ここに既存の OceanOS インストールがあります。最新バージョンに更新されます。",
  confirmReplace:
    "ここにフォルダがありますが、有効な OceanOS インストールではありません。インストールすると削除されて置き換えられます。",
  confirmNotInherited:
    "OceanOS を別の場所、またはコマンドラインでインストールした場合、それは引き継がれません。",
  ...
  useExistingDone:
    "既存のインストールを設定しました。OceanOS を終了して再度開くと適用されます。",
  useExistingQuitBtn: "OceanOS を終了",
} as const;
