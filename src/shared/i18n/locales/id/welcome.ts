export default {
  title: "Selamat datang di OceanOS",
  subtitle:
  ...
  dividerOr: "atau",
  connectRemote: "Hubungkan ke OceanOS Remote",
  connectRemoteTitle: "Hubungkan ke OceanOS Remote",
  connectRemoteSubtitle: "Masukkan URL server OceanOS API yang sedang berjalan.",
