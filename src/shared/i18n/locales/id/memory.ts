export default {
  title: "Memori",
  subtitle:
    "Hal yang diingat OceanOS tentang Anda dan lingkungan Anda di berbagai sesi.",
  sessions: "Sesi",
  messages: "Pesan",
  memories: "Memori",
  ...
  noMemoriesYet:
    "Belum ada memori. OceanOS akan menyimpan fakta penting saat Anda chat.",
  ...
  userProfileHint:
    "Beri tahu OceanOS tentang diri Anda - nama, peran, preferensi, dan gaya komunikasi.",
  providersHint:
    "Provider memori pluggable memberi OceanOS memori jangka panjang yang lebih canggih. Memori bawaan (di atas) selalu aktif bersama provider yang dipilih.",
