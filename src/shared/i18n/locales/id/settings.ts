export default {
  ...
  analytics: {
    ...
    hint: "Membantu meningkatkan OceanOS dengan mengirim data penggunaan anonim dan teragregasi ke instans PostHog proyek (di-host di UE). Anda dapat menonaktifkannya kapan saja.",
    disclosure: {
  ...
  updateSuccess: "OceanOS berhasil diperbarui.",
  ...
  poolHint:
    "Tambahkan beberapa API Key untuk provider yang sama agar OceanOS dapat melakukan rotasi otomatis dan load balancing.",
  add: "Tambah",
  remove: "Hapus",
  keyLabel: "Key",
  empty: "(kosong)",
  dataSection: "Data",
  dataHint:
    "Ekspor atau impor konfigurasi OceanOS, sesi, skill, dan memori Anda.",
  ...
  migrationDesc:
    "OpenClaw ditemukan di <code>{{path}}</code>. Anda dapat memigrasikan konfigurasi, API key, sesi, dan skill ke OceanOS.",
  migrationDismiss: "Jangan tampilkan lagi",
  migrating: "Memigrasikan...",
  migrateToOceanOS: "Migrasi ke OceanOS",
  skip: "Lewati",
  ...
  modeLocal: "Lokal",
  modeRemote: "Remote",
  modeLocalHint: "Menggunakan OceanOS yang terinstal di perangkat ini",
  modeRemoteHint: "Hubungkan ke server OceanOS API di jaringan atau cloud Anda",
  remoteUrl: "URL Remote",
  remoteUrlHint:
    "URL server OceanOS API (harus mengekspos /health dan /v1/chat/completions)",
