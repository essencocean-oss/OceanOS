export default {
  title: "Bellek",
  subtitle:
    "OceanOS'in oturumlar arasında sizin ve ortamınız hakkında hatırladıkları.",
  sessions: "Oturumlar",
  messages: "Mesajlar",
  memories: "Anılar",
  ...
  noMemoriesYet:
    "Henüz anı yok. OceanOS sohbet ederken önemli bilgileri kaydedecek.",
  ...
  userProfileHint:
    "OceanOS'e kendinizden bahsedin — ad, rol, tercihler, iletişim tarzı.",
  providersHint:
    "Takılabilir bellek sağlayıcıları, OceanOS'e gelişmiş uzun süreli bellek verir. Yerleşik bellek (yukarıda) seçilen sağlayıcının yanında her zaman aktiftir.",
