export default {
  ...
  dividerOr: "veya",
  connectRemote: "Uzak OceanOS'e Bağlan",
  connectRemoteTitle: "Uzak OceanOS'e Bağlan",
  connectRemoteSubtitle: "Çalışan bir OceanOS API sunucusunun URL'sini girin.",
