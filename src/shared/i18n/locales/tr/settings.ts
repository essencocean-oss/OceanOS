export default {
  ...
  analytics: {
    ...
    hint: "OceanOS One'ı iyileştirmeye yardımcı olmak için anonim, toplulaştırılmış kullanım verilerini projenin PostHog örneğine gönderir. İstediğiniz zaman kapatabilirsiniz.",
    disclosure: {
  ...
  updateSuccess: "OceanOS başarıyla güncellendi.",
  ...
  poolHint:
    "Otomatik dönüşüm ve yük dengelemesi için aynı sağlayıcıya birden çok API Anahtarı ekleyin. OceanOS bunlar arasında geçiş yapacaktır.",
  add: "Ekle",
  remove: "Kaldır",
  keyLabel: "Anahtar",
  empty: "(boş)",
  dataSection: "Veri",
  dataHint:
    "OceanOS yapılandırmanızı, oturumlarınızı, yeteneklerinizi ve belleğinizi dışa veya içe aktarın.",
  ...
  migrationDesc:
    "<code>{{path}}</code> adresinde OpenClaw bulundu. Yapılandırmanızı, API anahtarlarınızı, oturumlarınızı ve yeteneklerinizi OceanOS'e taşıyabilirsiniz.",
  migrationDismiss: "Tekrar gösterme",
  migrating: "Taşınıyor...",
  migrateToOceanOS: "OceanOS'e Taşı",
  skip: "Geç",
  ...
  modeLocal: "Yerel",
  modeRemote: "Uzak",
  modeLocalHint: "Bu cihazda yüklü OceanOS kullanılıyor",
  modeRemoteHint:
    "Ağınızdaki veya buluttaki bir OceanOS API sunucusuna bağlanın",
  remoteUrl: "Uzak URL",
  remoteUrlHint:
    "OceanOS API sunucusu URL'si (/health ve /v1/chat/completions endpoint'lerini sunmalıdır)",
  ...
  communityHint: "Sorular sormak, sorunları bildirmek ve diğer OceanOS kullanıcılarıyla sohbet etmek için Discord kanalımıza katılın.",
  joinDiscord: "Discord Kanalına Katıl",

  // SSH & Server Config
  modeSsh: "SSH Tüneli",
  modeSshHint: "SSH üzerinden uzak bir OceanOS'e tünel oluşturun — açık bağlantı noktası veya API anahtarı gerekmez.",
  ...
  sshRemotePort: "Uzak OceanOS Portu",
