export default {
  ...
  auxiliaryDescription:
    'Auxiliary tasks handle side-jobs like vision, compression, and web extraction. auto means "use the main model". Override per-task when you want a cheap/fast model for a specific job.',
  ...
  matrixUserHint: "e.g. @oceanos:matrix.org",
