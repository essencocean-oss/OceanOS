export default {
  ...
  dividerOr: "or",
  connectRemote: "Connect to Remote OceanOS",
  connectRemoteTitle: "Connect to Remote OceanOS",
  connectRemoteSubtitle: "Enter the URL of a running OceanOS API server.",
