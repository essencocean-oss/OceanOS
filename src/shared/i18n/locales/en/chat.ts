export default {
  ...
  reasoningEffort: {
    ...
    auto: "Auto",
    autoDescription: "Let OceanOS and the model decide.",
  ...
  deny: "Deny",
  clarify: {
    defaultQuestion: "OceanOS needs your input.",
    placeholder: "Type your answer…  (Ctrl+Enter to send)",
    send: "Send",
    skip: "Skip — let OceanOS decide",
    skipped: "Skipped — OceanOS decided",
