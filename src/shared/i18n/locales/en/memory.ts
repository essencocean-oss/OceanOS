export default {
  title: "Memory",
  subtitle:
    "What OceanOS remembers about you and your environment across sessions.",
  sessions: "Sessions",
  messages: "Messages",
  memories: "Memories",
  ...
  noMemoriesYet:
    "No memories yet. OceanOS will save important facts as you chat.",
  ...
  userProfileHint:
    "Tell OceanOS about yourself — name, role, preferences, communication style.",
  providersHint:
    "Pluggable memory providers give OceanOS advanced long-term memory. Built-in memory (above) is always active alongside the selected provider.",
