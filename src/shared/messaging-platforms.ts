...
export const MESSAGING_TOOLSET_DEFINITIONS: MessagingToolsetDefinition[] = [
  {
    ...
    label: "Web search",
    description:
      "Use the configured Ocean web/search backend. This still requires a working web backend in config.",
  },
  {
    key: "browser",
    label: "Browser",
  ...
  },
  {
    ...
    label: "Files",
    description:
      "Read and write files reachable by Ocean from the messaging platform.",
    risk: "high",
  },
  {
    key: "code_execution",
  ...
  },
  {
    key: "skills",
    label: "Skills",
    description: "List, inspect, and manage Ocean skills.",
  },
  {
    key: "memory",
    label: "Memory",
    description: "Read and update Ocean memory.",
  },
  {
    key: "session_search",
    label: "Session search",
    description: "Search previous Ocean sessions.",
  },
  {
    key: "clarify",
    label: "Clarify",
  ...
  },
  {
    key: "kanban",
    label: "Kanban",
    description: "Read and manage Ocean kanban tasks.",
  },
  {
    key: "delegation",
    label: "Delegation",
...
const ENV_DEFINITIONS: Record<string, MessagingEnvDefinition> = {
  ...
  API_SERVER_ENABLED: {
    ...
    description: "Expose Ocean through its OpenAI-compatible HTTP API",
    advanced: true,
  },
  API_SERVER_KEY: {
    key: "API_SERVER_KEY",
...
export const MESSAGING_PLATFORM_CATALOG: MessagingPlatformDefinition[] = [
  {
    id: "telegram",
    name: "Telegram",
    description: "Run Ocean from Telegram DMs, groups, and topics.",
  ...
  },
  {
    id: "discord",
    name: "Discord",
    description: "Connect Ocean to Discord DMs, channels, and threads.",
  ...
  },
  {
    id: "slack",
    name: "Slack",
    description: "Use Ocean from Slack via Socket Mode.",
  ...
  },
  {
    id: "mattermost",
    name: "Mattermost",
    description: "Connect Ocean to Mattermost channels and direct messages.",
  ...
  },
  {
    id: "matrix",
    name: "Matrix",
    description: "Use Ocean in Matrix rooms and direct messages.",
  ...
  },
  {
    id: "whatsapp",
    name: "WhatsApp",
    description: "Use Ocean through the bundled WhatsApp bridge with QR-based auth.",
  ...
  },
  {
    ...
    description: "Use Ocean through iMessage via a BlueBubbles server.",
  ...
  },
  {
    id: "homeassistant",
    name: "Home Assistant",
    description: "Control your smart home from Ocean via Home Assistant.",
  ...
  },
  {
    id: "email",
    name: "Email",
    description: "Talk to Ocean through an IMAP/SMTP mailbox.",
  ...
  },
  {
    id: "dingtalk",
    name: "DingTalk",
    description: "Connect Ocean to DingTalk groups.",
  ...
  },
  {
    id: "feishu",
    name: "Feishu / Lark",
    description: "Use Ocean inside Feishu / Lark.",
  ...
  },
  {
    id: "qqbot",
    name: "QQ Bot",
    description: "Connect Ocean to a QQ Bot from the QQ Open Platform.",
  ...
  },
  {
    id: "yuanbao",
    name: "Yuanbao",
    description: "Connect Ocean to Tencent Yuanbao.",
  ...
  },
  {
    id: "api_server",
    name: "API server",
    description: "Expose Ocean as an OpenAI-compatible HTTP API for tools like Open WebUI.",
