<img width="100%" alt="OCEANOS" src="previews/header.webp" />
...
> **This project is in active development.** Features may change, and some things might break. If you run into a problem or have an idea, [open an issue](https://github.com/essencocean-oss/OceanOS/issues). Contributions are welcome!
...
> ```
>
> Tracked in [#109](https://github.com/essencocean-oss/OceanOS/issues/109).
...
Contributions are welcome! Check out the [Contributing Guide](CONTRIBUTING.md) to get started. If you're not sure where to begin, take a look at the [open issues](https://github.com/essencocean-oss/OceanOS/issues). Found a bug or have a feature request? [File an issue](https://github.com/essencocean-oss/OceanOS/issues/new).
